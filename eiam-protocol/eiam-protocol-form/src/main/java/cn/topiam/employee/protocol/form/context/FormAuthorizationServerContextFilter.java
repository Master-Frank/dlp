 ...
 */
package cn.topiam.employee.protocol.form.context;
...
public final class FormAuthorizationServerContextFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(@NonNull HttpServletRequest request,
        ...
        try {
            ...
            //查询应用信息封装上下文
            FormApplicationService applicationService = (FormApplicationService) applicationServiceLoader.getApplicationServiceByAppCode(appCode);
    ...
    */
    ...
    public Map<String, Object> getConfig() {
        ...
        config.put(FormProtocolConfig.class.getName(), this.config);
        return config;
    }
