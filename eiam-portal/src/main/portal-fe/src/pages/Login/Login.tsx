...
import { Alert, App, Avatar, Skeleton, Space, Spin, Tabs, Tooltip, Flex } from 'antd';
                  ...
                  {!status && !forgetPassword && (
                    <>
                      <div className={`${prefixCls}-top`}>
                        <img alt="logo" className={`${prefixCls}-logo`} src={'/logo.svg'} />
                      ...
                      <div className={`${prefixCls}-main`}>
                        ...
                        {/*      <span style={{ color: '#1890FF' }}>关注公众号</span>，发送*/}
                        {/*      <span style={{ color: '#ff4626' }}>博士哥牛逼</span>，获取账号密码*/}
                        {/*    </p>*/}
                        {/*  </div>*/}
                        {/*</Modal>*/}
                        <>
