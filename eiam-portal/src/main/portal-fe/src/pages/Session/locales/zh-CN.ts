...
export default {
  'pages.other.session.desc':
    '会话管理可以查看所有当前仍然有效的会话列表，并且可以强制注销某个会话。注销后，该会话凭证即刻失效，之后的所有操作都需要重新认证。',
  'pages.other.session.column.session_id': '会话 ID',
  'pages.other.session.column.username': '用户名称',
  'pages.other.session.column.ip': '会话 ID',
  ...
  'pages.other.session.delete': '下线',
  'pages.other.session.delete.confirm': '您确定要下线该用户吗？',
  'pages.other.session.batch-delete': '批量下线',
  'pages.other.session.batch-delete.confirm': '您确定要批量下线选中用户吗？',
};
