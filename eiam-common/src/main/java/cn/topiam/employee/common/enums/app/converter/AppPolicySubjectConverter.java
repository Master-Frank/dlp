...
public class AppPolicySubjectConverter implements AttributeConverter<AppPolicySubjectType, String> {
     ...
     */
    @Override
    public String convertToDatabaseColumn(AppPolicySubjectType attribute) {
     ...
     */
    @Override
    public AppPolicySubjectType convertToEntityAttribute(String dbData) {
        return AppPolicySubjectType.getType(dbData);
    }
}
