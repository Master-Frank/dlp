...
export default {
  ...
  'pages.setting.storage_provider.provider.aliyun_oss.domain.placeholder': '请输入阿里云 外链域名',
  ...
  'pages.setting.storage_provider.provider.aliyun_oss.access_key_secret.placeholder':
    '请输入阿里云 AccessKeySecret',
  'pages.setting.storage_provider.provider.aliyun_oss.access_key_secret.rule.0.message':
    '阿里云 AccessKeySecret为必填项',
  'pages.setting.storage_provider.provider.aliyun_oss.region.placeholder': '请输入阿里云 Region',
  'pages.setting.storage_provider.provider.aliyun_oss.bucket.placeholder': '请输入阿里云 Bucket',
  ...
  'pages.setting.storage_provider.provider.qiniu_kodo.region.placeholder':
    '请输入七牛云Kodo Region',
  ...
  'pages.setting.storage_provider.provider.qiniu_kodo.bucket.rule.0.message':
    '七牛云Kodo Bucket为必填项',
  'pages.setting.storage_provider.provider.minio.endpoint': 'MinIO域名',
  ...
  'pages.setting.storage_provider.provider.minio.domain': '外链域名',
  'pages.setting.storage_provider.provider.minio.domain.placeholder': '请输入MinIO 外链域名',
  'pages.setting.storage_provider.provider.minio.domain.rule.0.message': 'MinIO 外链域名为必填项',
