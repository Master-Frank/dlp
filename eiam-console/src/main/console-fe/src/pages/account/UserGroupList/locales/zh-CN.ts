...
export default {
  ...
  'pages.account.user_group_list.column.name': '组名称',
  'pages.account.user_group_list.column.code': '组编码',
  'pages.account.user_group_list.column.remark': '备注',
  'pages.account.user_group_list.column.create_time': '创建时间',
  'pages.account.user_group_list.column.option': '操作',
  'pages.account.user_group_list.column.option.delete_title': '确定要删除该用户组吗？',
  'pages.account.user_group_list.column.option.delete_content': '删除操作无法恢复，请谨慎操作！',
  'pages.account.user_group_list.create_button': '新增用户组',
