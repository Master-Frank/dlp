...
const prefixCls = 'user-detail-access-strategy';
                    ...
                    onClick={() => {
                      const confirmed = modal.error({
                        title: intl.formatMessage({
                          id: 'pages.account.user_detail.access_strategy.remove_title',
                        }),
                        content: intl.formatMessage({
                          id: 'pages.account.user_detail.access_strategy.remove_content',
                        }),
