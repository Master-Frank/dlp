...
export default {
  ...
  'pages.authn.identity_provider.desc':
    '支持设置多种身份提供商，企业用户即可通过不同方式登录门户。系统默认的认证源为用户密码和短信快捷认证，您还可添加钉钉、微信、企业微信、QQ等作为认证源。',
  'pages.authn.identity_provider.social': '社交认证源',
  'pages.authn.identity_provider.enterprise': '企业认证源',
  'pages.authn.identity_provider.delete_confirm_title': '确定要删除认证源吗？',
  'pages.authn.identity_provider.delete_confirm_content': '删除操作无法恢复，请谨慎操作！',
  'pages.authn.identity_provider.enable_confirm_title': '确定要启用该认证吗？',
  'pages.authn.identity_provider.enable_confirm_content': '启用后该认证源将恢复正常。',
  'pages.authn.identity_provider.disable_confirm_title': '您是否要禁用认证源吗？',
  'pages.authn.identity_provider.disable_confirm_content': '禁用后该认证源将无法使用。',
  ...
  'pages.authn.identity_provider.create_modal.form.type.wechat_oauth': '微信认证',
