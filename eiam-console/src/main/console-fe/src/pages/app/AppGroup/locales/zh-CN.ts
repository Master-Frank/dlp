...
export default {
  ...
  'pages.app_group.list.actions.delete.title': '确定要删除此应用分组？',
  'pages.app_group.list.actions.delete.content': '删除操作无法恢复，请谨慎操作！',
  'pages.app_group.list.actions.batch_delete.title': '确定批量删除选中的应用分组吗？',
  'pages.app_group.list.actions.batch_delete.content': '删除操作无法恢复，请谨慎操作！',
