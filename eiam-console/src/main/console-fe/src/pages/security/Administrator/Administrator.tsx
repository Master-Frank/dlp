...
import { App, Badge, Button, Space, Switch, Table } from 'antd';
          ...
          <Switch
            ...
            onChange={async (checked: boolean, event) => {
              ...
              if (checked) {
                modal.warning({
                  title: intl.formatMessage({
                    id: 'pages.security.administrator.columns.option.enable_confirm_title',
                  }),
                  content: intl.formatMessage({
                    id: 'pages.security.administrator.columns.option.enable_confirm_content',
                  }),
              ...
              modal.warning({
                title: intl.formatMessage({
                  id: 'pages.security.administrator.columns.option.disable_confirm_title',
                }),
                content: intl.formatMessage({
                  id: 'pages.security.administrator.columns.option.disable_confirm_content',
                }),
                okText: intl.formatMessage({ id: 'app.confirm' }),
                okType: 'primary',
                cancelText: intl.formatMessage({ id: 'app.cancel' }),
                    ...
                    <a
                      ...
                      onClick={(e) => {
                        ...
                        const confirmed = modal.error({
                          title: intl.formatMessage({
                            id: 'pages.security.administrator.columns.option.delete_confirm_title',
                          }),
                          content: intl.formatMessage({
                            id: 'pages.security.administrator.columns.option.delete_confirm_content',
                          }),
                          okText: intl.formatMessage({ id: 'app.confirm' }),
                          centered: true,
                          okType: 'primary',
