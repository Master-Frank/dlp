...
- `.Codex/commands/opsx/` — slash commands `propose / explore / apply / archive` drive the flow
...
- `.Codex/settings.local.json` is gitignored; project-level non-secret settings go in `.Codex/settings.json`.
